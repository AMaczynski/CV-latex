...
\textbf{Budimex S.A.} \descript{| Dynamic Traffic Management}
\location{Java 21, Spring Boot, PostgreSQL, MQTT, Apache Kafka, Liquibase}
\justify
...
\sectionsep
\sectionsep
\textbf{Profitowi S.A.} \descript{| Commission Management System}
\location{Java 21, Spring Boot, PostgreSQL, MQTT, Apache Kafka, Liquibase}
\justify
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\minibreak % Wymusza przejście na nową stronę
...
\sectionsep
\location{AGH University of Science and Technology}
\descript{Engineer’s degree in Computer Science}
